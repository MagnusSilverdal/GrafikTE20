 ...
 */
public class GrafikTE20Del3 extends Canvas {
    // Storleken på bilden
     ...
     */
    public GrafikTE20Del3() {
        JFrame frame = new JFrame("Del 3");
     ...
     * Ändra molnets x-koordinat lite och sedan rita om allt igen. Flimrar som bara den...
     * Och det går på tok för fort...
     */
    ...
    public static void main(String[] args) {
        GrafikTE20Del3 exempel = new GrafikTE20Del3();
    }
}
