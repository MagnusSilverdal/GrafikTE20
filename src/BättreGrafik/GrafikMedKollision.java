 ...
 */
public class GrafikMedKollision extends Canvas implements Runnable{
    ...
    public static void main(String[] args) {
        GrafikMedKollision minGrafik = new GrafikMedKollision();
    ...
    /*
        MousemotionListener lyssnar efter mousemoves
     */
    private class MML implements MouseMotionListener {
        ...
        public void mouseMoved(MouseEvent mouseEvent) {
            ...
            striker.x = mouseEvent.getX();
            striker.y = mouseEvent.getY();
            // Om de två rektanglarna överlappar så flytta target till en ny plats
