 ...
 */
public class GrafikTE20Del3_2 extends Canvas {
    // Storleken på bilden
     ...
     */
    public GrafikTE20Del3_2() {
        JFrame frame = new JFrame("Del 3_2");
     ...
     * Ändra molnets x-koordinat lite och sedan rita om allt igen.
     * Med en lagom lång sleep så får vi bort en del av flimret och hastigheten går ner. Men vi kan inte styra den på
     * något bra sätt och vi kan inte utnyttja tiden till något vettigt
     */
    ...
    public static void main(String[] args) {
        GrafikTE20Del3_2 exempel = new GrafikTE20Del3_2();
    }
}
